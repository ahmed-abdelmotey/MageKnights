...
function getClickPosition(e) {
    ...
    bullet[Bcount].src = "../img/bullet2.png";
...
/////////////////////////// Removing stray bullets


setInterval(BulltRemover, 50);

function BulltRemover() {
    for (var i = 0; i < bullet.length; i++) {

        if (parseInt(bullet[i].style.left) < 0 || parseInt(bullet[i].style.top) < 0 || parseInt(bullet[i].style.left) > MaxLeft || parseInt(bullet[i].style.top) > MaxTop) {
...
/*    for (var i = 0; i < imag1.length; i++) {

        imag1[i].style.left = (parseInt(imag1[i].style.left) + (10 * Dir[i]));

        //alert(rorox[i].style.left);
        if (parseInt(imag1[i].style.left) > MaxLeft || parseInt(imag1[i].style.left) < 0) {
            Dir[i] *= -1;
        }

    }*/
    for (var i = 0; i < imag2.length; i++) {
        imag2[i].style.top = (parseInt(imag2[i].style.top) + (10 * Dir2[i]));
        if (parseInt(imag2[i].style.top) > MaxTop || parseInt(imag2[i].style.top) < 0) {
            Dir2[i] *= -1;
        }
    }
}
...
var audio = new Audio('../sound/pre.mp3');
var audio2 = new Audio('../sound/Epic.mp3');
audio2.play();
